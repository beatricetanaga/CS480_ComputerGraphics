...
public class Component implements Rotatable, Nameable, UpdatingDisplayable, Colorable {
	...
	public void update(final GL2 gl) {
		...
		// Give displayable object display list handle to current component
		// So we can use this index to access data and draw on screen
		if (this.displayable != null) {
			this.callListHandle = this.displayable.get_handle();
		}
