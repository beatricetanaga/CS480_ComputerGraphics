...
//						^ (byte) ((j & 0x8) == 0 ? 0x00 : 0xff))));
				checkImageBuf.put((byte) 193);
				checkImageBuf.put((byte) 225);
				checkImageBuf.put((byte) 236);
			}
		}
	...
	private void initTexture(GL2 gl) {
		...
		gl.glTexImage2D(GL.GL_TEXTURE_2D, 0, 3, CHECK_IMAGE_WIDTH, CHECK_IMAGE_HEIGHT, 0, GL.GL_RGB,
	...
	public void initialize(GL2 gl) {
		...
		initTexture(gl);
		callListHandle = gl.glGenLists(1);

		gl.glNewList(callListHandle, GL2.GL_COMPILE);
		
		gl.glPushAttrib(GL2.GL_CURRENT_BIT);
		gl.glColor3f(0.3f,0.7f,0.85f); // purple
