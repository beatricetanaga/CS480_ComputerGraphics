...
public class SketchBase 
{
	 ...
	 *          Point to be drawn.
	 */
	public static void drawPoint(BufferedImage buff, int[][] d_buff, Point3D p)
	{
	 ...
	 */
	public static void drawLine(BufferedImage buff, int[][] d_buff, Point3D p1, Point3D p2)
	{
	 ...
	 */
	public static void drawTriangle(BufferedImage buff, int[][] d_buff, Point3D p1, Point3D p2, Point3D p3, boolean do_smooth)
	{
